...
export default function CRMPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="border-b border-neutral-200 dark:border-white/[0.06] px-6 py-4 flex items-center gap-4 glass">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-neutral-900 dark:text-neutral-900 dark:text-white">CRM</h1>
            <p className="text-xs text-neutral-400 dark:text-neutral-500">{pipeline?.name ?? 'Pipeline'}</p>
          </div>
        </div>
