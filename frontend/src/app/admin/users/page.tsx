  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-neutral-900 dark:text-neutral-900 dark:text-white">Usuários</h1>
          <p className="text-xs text-neutral-400 dark:text-neutral-500">Gerencie equipe e permissões</p>
        </div>
      </div>
      ...
      <div className="glass-card rounded-xl border border-neutral-200 dark:border-white/[0.06] overflow-hidden">
        <div className="px-5 py-4 border-b border-neutral-200 dark:border-white/[0.06] flex items-center gap-2">
          <h2 className="text-sm font-semibold text-neutral-900 dark:text-neutral-900 dark:text-white">Equipe</h2>
        ...
        <div className="p-5 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <Select value={form.role} onValueChange={(v: string | null) => setForm(f => ({ ...f, role: v ?? f.role }))}>
              <SelectTrigger className="bg-neutral-50 dark:bg-white/5 border-neutral-200 dark:border-white/10 h-9 text-sm"><SelectValue /></SelectTrigger>
